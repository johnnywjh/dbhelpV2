...
import com.sesame.common.response.AbstractResponse;
import com.sesame.common.web.AbstractRequest;
...
public class ReqParamsAspect {
    ...
    @Around("@annotation(com.sesame.common.annotation.ReqParamsCheck)")
